...
Training may introduce new knowledge, build skills, create opportunities for practice, or support changes in behaviour. But training alone rarely creates impact. Impact depends on whether learners can apply what they learn, whether the environment supports change, and how well the training is aligned with real needs.
...
- Center for Theory of Change
  → Supports: background, benefits, origin and rationale of Theory of Change
  → Why it matters: mastering the theory of change can be very powerful for programme and project development
  → Source: [https://www.theoryofchange.org/](https://www.theoryofchange.org/)
