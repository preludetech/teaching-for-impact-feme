---
used_in:
- "Part 1 — [Lesson 5: Learning Outcomes and Alignment](../part-1/lesson-5.md#in-practice)"
- "Part 1 — [Lesson 9: Assessment for Learning](../part-1/lesson-9.md#in-practice)"
...
- Your outcomes from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md)
...
- Pick one outcome from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md) and trace it through: is the path from outcome to activity to assessment coherent?
...
Start with your outcomes from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md). For each one, draft what activity could address it and what evidence would show a learner has met it. Leave the Assessment column as a placeholder if you have not yet designed assessment — you will return to fill it in after Lesson 9.
...
- [Activity 10: Assessment Plan](../activities/activity_10_assessment.md) — your alignment table provides the foundation for designing assessment
- [Activity 13: Training Design Snapshot](../activities/activity_13_snapshot.md) — your alignment table feeds into the overall design summary

---

## Iteration

Return to this table after completing [Activity 10: Assessment Plan](../activities/activity_10_assessment.md). At that point, fill in or revise the Assessment column based on your assessment design work from Lesson 9.
