---
used_in:
- "Part 1 — [Lesson 7: Designing Learning Activities](../part-1/lesson-7.md#in-practice)"
- "Part 1 — [Lesson 8: Practice, Feedback, and Iteration](../part-1/lesson-8.md#in-practice)"
...
- One outcome from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md)
- One learner constraint from [Activity 3: Learner Reality Mapping](../activities/activity_3_learner_reality.md)
...
- Pick one learner constraint from [Activity 3: Learner Reality Mapping](../activities/activity_3_learner_reality.md) — how does that constraint affect this activity?

---

### Redesign

- **Objective** (use one outcome from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md)):
...
Design one core activity using one outcome from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md).
...
- [Activity 6: Alignment Table](../activities/activity_6_alignment.md) — check that this activity aligns with outcomes and assessment
- [Activity 9: Practice & Feedback Plan](../activities/activity_9_practice_feedback.md) — your activity design feeds into planning practice and feedback
- [Activity 13: Training Design Snapshot](../activities/activity_13_snapshot.md) — this activity becomes part of your overall training design summary

---

## Iteration

Return to this activity after completing [Activity 9: Practice & Feedback Plan](../activities/activity_9_practice_feedback.md). Revise how feedback and iteration are built into the activity based on what you design there.
