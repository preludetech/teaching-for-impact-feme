...
what_to_do: "Define indicators, assessment methods, and evidence sources for your training"
expected_output: "An assessment plan linking outcomes to observable evidence"
...
- Your practice and feedback design from [Activity 9: Practice & Feedback Plan](../activities/activity_9_practice_feedback.md)
...
For each outcome from [Activity 5: Learning Outcomes](../activities/activity_5_learning_outcomes.md):
...
- [Activity 12: Evaluation Plan](../activities/activity_12_evaluation_plan.md) — your assessment plan provides the foundation for longer-term evaluation
- [Activity 13: Training Design Snapshot](../activities/activity_13_snapshot.md) — your assessment design feeds into the overall training summary

---

## Iteration

Return to this plan after reviewing your [Activity 6: Alignment Table](../activities/activity_6_alignment.md). Check that every assessed outcome has a corresponding activity, and every activity connects to an assessment. Gaps in either direction signal a design problem worth fixing.
